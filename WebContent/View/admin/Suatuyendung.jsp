...
<% TuyenDung tuyendung = (TuyenDung)request.getAttribute("tuyendung"); %>
<div class="center-right-title">Cập nhật tuyển dụng</div>
...
<div class="col-sm-12 col-xs-12 center-right-main-admin">
  <div class="center-right-main-admin-child"> 	
		  ...
		  action="${ pageContext.request.contextPath}/admin/tuyendung/<%=tuyendung.getId() %>/update" method="post" >
		  <div class="form-group">	  
		    <label class="control-label td-title col-sm-2" >Tiêu đề (*)</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" value="<%=tuyendung.getTitle() %>"
